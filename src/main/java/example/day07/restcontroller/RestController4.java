...
public class RestController4 {
    ...
    @GetMapping("/test2")   //전제 조건 : 쿼리스트링 key 이름과 메소드의 매개변수명이 동일해야 한다.
    ...
    //[3] HTTP GET
    @GetMapping("/test3") //http://localhost:8080/example/test3?key1=qwe&key2=123
    public String test3(@RequestParam("key1")String name, @RequestParam("key2")int age){
        //쿼리스트링의 KEY 이름과 메소드의 매개변수명이 동일하지 않기 때문에 오류 해결방안 @RequestParam("key") 타입 매개변수명 사용
    ...
    //[4] HTTP GET
    @RequestMapping("/test4") //http://localhost:8080/example/test4?key1=qwe&key2=123
